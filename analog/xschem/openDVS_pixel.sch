...
N 450 0 550 0 {lab=#net3}
N 630 -170 630 0 {lab=pix_rst}
N 380 -70 400 -70 {lab=#net2}
N 380 -70 380 -50 {lab=#net2}
N 380 -50 380 -40 {lab=#net2}
...
C {sky130_fd_pr/photodiode.sym} -90 100 0 0 {name=D1
model=photodiode
area=9e-12
perim=12e-6
spiceprefix=X
