...
"
spice_ignore=false}
C {code_shown.sym} -440 170 0 0 {name=NGSPICE
only_toplevel=true
value="
.control
.param I_PH = 1e-9
...
C {vsource.sym} 140 60 0 0 {name=vsf value=SF_BIAS savecurrent=false}
C {gnd.sym} 140 90 0 0 {name=l11 lab=GND}
...
C {isource.sym} 10 140 0 0 {name=Iphoto value=I_PH}
C {sky130_fd_pr/pfet_01v8.sym} 210 200 0 0 {name=M2
W=1
L=0.15
nf=1
mult=1
...
C {sky130_fd_pr/pfet_01v8.sym} 210 30 0 0 {name=M3
W=1
L=0.15
nf=1
mult=1
...
C {vdd.sym} 260 30 1 0 {name=l8 lab=VDD}
C {vdd.sym} 260 200 1 0 {name=l9 lab=VDD}
